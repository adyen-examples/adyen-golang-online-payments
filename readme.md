...
docker run -e "PORT=8080" 
  -e "ADYEN_API_KEY=abc123" 
  -e "ADYEN_MERCHANT_ACCOUNT=TestAccount123" 
  -e "ADYEN_CLIENT_KEY=tyu123" 
  --rm --name adyen-golang-online-payments -p 8080:8080 adyen/golang-online-payments
```
